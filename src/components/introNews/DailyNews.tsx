...
import styles from './daily-news.module.scss';
								...
								>
									...
									<div className='h-52 w-full p-4'>
										<h1 className={`${cx('title')} h-14 text-xl mb-3`}>
											...
											quisquam explicabo molestias? Sint quis eligendi sit, repellendus vitae
											delectus? Sit voluptatum vel asperiores! Quas accusantium labore soluta unde
											voluptates.
										</h1>
